...
In the directory bin/ and lib/ are binaries of standalone tools compiled on Ubuntu 18.04.2 LTS and targetting an Intel Skylake or newer processors. They are included solely to enable fast software evaluations.
