 ...
 */
static char *strmatch(char *cp, char *string, char termc)
{
 ...
 */
static char *yearmatch(char *cp, char *format, struct tm *tm, int *hadyearp)
{
	register int c;
	char *savecp;
	int saveyear;
 ...
 */
static char *cvtnum(register char *cp, int *nump)
{
	register int c;
	register int i;
 ...
 */
static char * skipnws(register char *format)
{
	register char c;
