...
static const struct {
  ...
  {"XMLBASE",     _XMLBASE,    GDT_TRUE}, { "YAHOOLIST",  _YAHOOLIST,  GDT_TRUE},
...
//cerr << "Looking for " << Doctype << endl;
  Object *r = Handlers.Find(Doctype.ToUpper());
...
//cerr << "Doctypes " << DocType << " ----> " << Ptr->Id << "/" << Ptr->Name << endl;
}
...
{
#ifndef _WIN32
  STRING SearchPath("~/.ib/plugins:/var/opt/BSN/plugins:\
~asfadmin/lib/plugins:~ibadmin/lib/plugins:/opt/BSN/lib/plugins:.");
...
{
//cerr << "Plugin exsits called" << endl;
	  ...
	  if (!Fn.IsEmpty())
	    {
	      ...
	      dt_name.ToLower();
//cerr << "Open Plugin Contructor in " << dt_name << endl;
	      dt_constr_t create = open_doctype_constr(Fn, dt_name);
	      if (create != NULL)
		{
//cerr << "Now Register" <<endl;
...
{
//cerr << "OpenDoctypeContructor" << endl;
