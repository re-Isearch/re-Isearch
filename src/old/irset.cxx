#pragma ident  "@(#)irset.cxx  1.106 06/07/01 02:41:07 BSN"
  ...
  if (ByWhat.IsNumber())
   ...
   default:
    if (strncasecmp(ByWhat, "private",  7) == 0)
      {
	SortByPrivate( atoi(ByWhat.c_str() + 7) );
	break;
      }
...
// Special
OPOBJ *atomicIRSET::WithinKey(const STRING& KeySpec)
{
