...
*/
#ifndef __STRING2HXX__
#define __STRING2HXX__ 1

#define WANT_I18_STRING 0

#ifdef __GNUG__
#pragma interface "string2.hxx"
#endif
...
public:
 ...
 ~STRING();
  ...
  //@{
    ...
    const unsigned char * const c_ustr() const { return (const unsigned char * const)m_pchData; }
    ///
